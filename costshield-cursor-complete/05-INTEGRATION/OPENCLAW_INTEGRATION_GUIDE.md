...
```json5
{
  ...
  "models": {
    ...
    "providers": {
      "costshield": {
        "baseUrl": "https://proxy.costshield.cloud",  // CostShield proxy URL
...
```json5
{
  ...
  "models": {
    ...
    "providers": {
      "costshield": {
        "baseUrl": "https://proxy.costshield.cloud",
...
curl -I https://proxy.costshield.cloud/v1/chat/completions
...
```bash
# Test SSL connection
openssl s_client -connect proxy.costshield.cloud:443 -servername proxy.costshield.cloud
```

3. **Check firewall/network:**
```bash
# Test if port 443 is accessible
nc -zv proxy.costshield.cloud 443
```
...
curl -N https://proxy.costshield.cloud/v1/chat/completions \
...
curl https://proxy.costshield.cloud/v1/chat/completions \
...
curl -I https://proxy.costshield.cloud
     ...
     "models": {
       "providers": {
         "costshield-anthropic": {
           "baseUrl": "https://proxy.costshield.cloud/anthropic",
           "apiKey": "${COSTSHIELD_API_KEY}",
...
- CostShield Support: support@costshield.cloud
- CostShield Dashboard: https://dashboard.costshield.cloud
