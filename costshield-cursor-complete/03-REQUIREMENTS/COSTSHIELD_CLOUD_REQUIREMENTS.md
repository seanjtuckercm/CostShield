...
#### 1.1 Subdomain-Based (e.g., user123.costshield.cloud)
**Advantages**:
...
#### 1.2 Path-Based (e.g., costshield.cloud/api/v1/proxy)
**Advantages**:
...
const ALLOWED_ORIGINS = [
  'https://costshield.cloud',
  'https://app.costshield.cloud',
...
NODE_ENV=production
PORT=3000
APP_URL=https://costshield.cloud
...
SENDGRID_API_KEY=SG...
FROM_EMAIL=noreply@costshield.cloud
```
...
- [ ] Status page (status.costshield.cloud)
